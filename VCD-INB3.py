            ...
            if(w*h<200000):
                ...
                if (roi(x+w/2,y+h,img)==2):
                    ...
                    if w*h>3000:
                        cv2.rectangle(img, (x, y), (x + w, y + h), (0, 0 , 255), 2)
                        if x<300:
                            cv2.putText(img , 'APPROACHING LEFT' , (50, 50), cv2.FONT_HERSHEY_COMPLEX, 1,(0, 0, 255), 1)
                        else:
                            cv2.putText(img , 'APPROACHING RIGHT' , (600, 50), cv2.FONT_HERSHEY_COMPLEX, 1,(0, 0, 255), 1)
                    else:
